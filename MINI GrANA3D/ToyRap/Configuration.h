...
#define STRING_CONFIG_H_AUTHOR "(thorgal, ToyREP)" // Who made the changes.
...
#define CUSTOM_MENDEL_NAME "ToyREP"
...
#define PIDTEMP //run autotune M303 S185 to get the correct values
...
//#define PIDTEMPBED // FIND YOUR OWN: "M303 E-1 C8 S90" to run autotune on the bed at 90 degreesC for 8 cycles.
//
...
//PCB Heatbed MK1 20V
    ...
    #define  DEFAULT_bedKi 20.99
    #define  DEFAULT_bedKd 144.27
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {657.382, 657.060, 20378.864, 7026.994}  // calculation (32*63.68395*16)/50, (32*63.68395*16)/50, (32*63.68395*8)/0.8, (32*63.68395*16*36)/(9*7*3.1415926)
...
// Increase the FAN pwm frequency. Removes the PWM noise but increases heating in the FET/Arduin
//#define FAST_PWM_FAN

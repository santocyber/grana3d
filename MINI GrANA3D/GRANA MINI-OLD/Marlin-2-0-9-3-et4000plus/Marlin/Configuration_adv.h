...
//#define BACKLASH_COMPENSATION               //Backlash comp is currently broken in Marlin, don't use it
  ...
  #define BACKLASH_DISTANCE_MM { 0.4, 0.5, 0.0 } // (mm) One value for each linear axis
...
//#define LIN_ADVANCE
  ...
  #define LIN_ADVANCE_K 0.26    // Unit: mm compression per 1mm/s extruder speed
...
#define CUSTOM_USER_BUTTONS
  ...
  #define BUTTON1_PIN PC3
    ...
    #define BUTTON1_DESC          "start pause"  // Optional string to set the LCD status
  #endif
  ...
  #define BUTTON2_PIN PB3
    ...
    #define BUTTON2_WHEN_PRINTING false
     #define BUTTON2_GCODE         "G1 X50 Y50 Z90 F3000 M702"
    #define BUTTON2_DESC          "GO TO THE TOP E EJETA FILAMENTO"
  #endif
  ...
  #define BUTTON3_PIN PB5
    ...
    #define BUTTON3_GCODE         "M701"
    #define BUTTON3_DESC          "FILAMENT ENTRANDO"
  #endif
  #define BUTTON4_PIN PA11
  #if PIN_EXISTS(BUTTON4)
    #define BUTTON4_HIT_STATE     LOW
    #define BUTTON4_WHEN_PRINTING false
    #define BUTTON4_GCODE         "M25"
    #define BUTTON4_DESC          "PAUSE"
  #endif
#endif

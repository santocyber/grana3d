 ...
 */
#define THERMOCOUPLE_MAX_ERRORS 25
 ...
 */
   ...
   */
  #define WATCH_BED_TEMP_PERIOD                18000 // Seconds
...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { 5*60, 5*60, 5*60 } // (mm/min) Feedrates for manual moves along X, Y, Z, E from panel
 ...
 */
#define STARTUP_COMMANDS "M140 S50"
